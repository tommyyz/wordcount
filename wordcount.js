...
function TextStringMapper(UnicodeData, Arr) {
...
function TextWordBoundary(UnicodeData) {
...
function TextWordGetter(UnicodeData, StringMapper, WordBoundary) {
